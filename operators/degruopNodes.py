...
#shameless forklifed from https://github.com/Claw256/ungrouper
#go thank original author
...
class RFX_OT_UngroupSceneModal(Operator):
    bl_idname = "rfxutils.ungroup_scene_modal"
...
def register() -> None:
    bpy.utils.register_class(RFX_OT_UngroupSceneModal)

def unregister() -> None:
    bpy.utils.unregister_class(RFX_OT_UngroupSceneModal)
